...
class ZPaletteAttached : public QObject {
  ...
  Q_PROPERTY(ZPaletteAttached *extends READ extends WRITE setExtends NOTIFY
                 extendsChanged)
...
class ZPaletteItem : public QObject {
  ...
  Q_PROPERTY(
      QPalette::ColorGroup group READ group WRITE setGroup NOTIFY groupChanged)

  Q_PROPERTY(
      QPalette::ColorRole role READ role WRITE setRole NOTIFY roleChanged)
