...
namespace {
template <class T> void dataAppend(QQmlListProperty<QObject> *prop, QObject *object)
{
...
template <class T> qsizetype dataCount(QQmlListProperty<QObject> *prop)
{
    assert(prop);
...
template <class T> QObject *dataAt(QQmlListProperty<QObject> *prop, qsizetype i)
{
    assert(prop);
...
template <class T> void dataClear(QQmlListProperty<QObject> *prop)
{
    assert(prop);
...
{
    return QQmlListProperty<QObject>(this, nullptr, dataAppend<ZMenuBar>,
                                     dataCount<ZMenuBar>, dataAt<ZMenuBar>,
                                     dataClear<ZMenuBar>);
}
...
{
    return QQmlListProperty<QObject>(this, nullptr, dataAppend<ZMenu>, dataCount<ZMenu>,
                                     dataAt<ZMenu>, dataClear<ZMenu>);
}
