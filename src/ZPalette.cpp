...
ZPaletteAttached::ZPaletteAttached(QObject *parent)
    : QObject{parent}
{
...
QQmlListProperty<QObject> ZPaletteAttached::items()
{
    return QQmlListProperty<QObject>(
        ...
        [](QQmlListProperty<QObject> *prop, QObject *object) {
            ...
            qobject_cast<QWidget *>(palette->parent())->setPalette(palette->palette());
        },
...
ZPaletteAttached *ZPaletteAttached::extends() const
{
    return m_extends;
}
...
const QPalette &ZPaletteAttached::palette() const
{
    return m_palette;
}

ZPaletteItem::ZPaletteItem(QObject *parent)
    : QObject{parent}
{
}

QString ZPaletteItem::color() const
{
    return m_color;
}
...
QPalette::ColorGroup ZPaletteItem::group() const
{
    return m_group;
}
...
QPalette::ColorRole ZPaletteItem::role() const
{
    return m_role;
}
