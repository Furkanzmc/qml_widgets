...
class ZInputDialog : public QInputDialog
{
    ...
    Q_PROPERTY(
        InputMode inputMode READ inputMode WRITE setInputMode NOTIFY inputModeChanged)
    Q_PROPERTY(
        QString labelText READ labelText WRITE setLabelText NOTIFY labelTextChanged)
    Q_PROPERTY(
        InputDialogOptions options READ options WRITE setOptions NOTIFY optionsChanged)

    Q_PROPERTY(QLineEdit::EchoMode textEchoMode READ textEchoMode WRITE setTextEchoMode
                   NOTIFY textEchoModeChanged)
    Q_PROPERTY(bool comboBoxEditable READ isComboBoxEditable WRITE setComboBoxEditable
                   NOTIFY comboBoxEditableChanged)
    Q_PROPERTY(QStringList comboBoxItems READ comboBoxItems WRITE setComboBoxItems NOTIFY
                   comboBoxItemsChanged)

    Q_PROPERTY(
        int intMinimum READ intMinimum WRITE setIntMinimum NOTIFY intMinimumChanged)
    Q_PROPERTY(
        int intMaximum READ intMaximum WRITE setIntMaximum NOTIFY intMaximumChanged)
    Q_PROPERTY(int intStep READ intStep WRITE setIntStep NOTIFY intStepChanged)

    Q_PROPERTY(double doubleMinimum READ doubleMinimum WRITE setDoubleMinimum NOTIFY
                   doubleMinimumChanged)
    Q_PROPERTY(double doubleMaximum READ doubleMaximum WRITE setDoubleMaximum NOTIFY
                   doubleMaximumChanged)
    Q_PROPERTY(int doubleDecimals READ doubleDecimals WRITE setDoubleDecimals NOTIFY
                   doubleDecimalsChanged)

    Q_PROPERTY(QString okButtonText READ okButtonText WRITE setOkButtonText NOTIFY
                   okButtonTextChanged)
    Q_PROPERTY(QString cancelButtonText READ cancelButtonText WRITE setCancelButtonText
                   NOTIFY cancelButtonTextChanged)
    Q_PROPERTY(
        double doubleStep READ doubleStep WRITE setDoubleStep NOTIFY doubleStepChanged)

    Q_PROPERTY(QString textValue READ textValue WRITE setTextValue NOTIFY
                   textValueChangedInternal)
    Q_PROPERTY(
        int intValue READ intValue WRITE setIntValue NOTIFY intValueChangedInternal)
